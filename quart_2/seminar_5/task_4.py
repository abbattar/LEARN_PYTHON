...
with open('text_for_compression.txt', 'w', encoding='UTF-8') as file:
    file.write(input('Напишите текст необходимый для сжатия: '))
with open('text_for_compression.txt', 'r') as file:
...
with open('text_after_compression.txt', 'w', encoding='UTF-8') as file:
